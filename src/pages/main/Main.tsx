...
export default function Main() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white h-76 flex items-center justify-center w-full">
      <div className="relative z-10 px-6 py-24 text-center">
        <h1 className="text-[60px] font-bold text-red-600">TicketPulse: Your All-in-One Ticket Solution</h1>
         <p className="mt-4 text-lg text-red-600">
          Streamline your support with our powerful and 
          intuitive ticket management system. Create, track, and 
